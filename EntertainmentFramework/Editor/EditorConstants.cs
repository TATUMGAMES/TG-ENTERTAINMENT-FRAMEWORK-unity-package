...
{
    internal sealed class EditorConstants
    {
        internal const string UnityAnaltyicsLabel = " Enable Unity Analytics";
        internal const string AutoInitializeUnityAnalytics = "Enable Auto Initialize Unity Analytics Events";
        internal const string AutoTrackEventData = "Enable Auto Collecting Data For Tracking Unity Analytics Events";
        ...
        #endregion MikrosSettingsMenu

        #region Macros

        internal const string UNITY_ANALYTICS_ADDED = "UNITY_ANALYTICS_ADDED";
        internal const string UNITY_ANALYTICS_ENABLED = "UNITY_ANALYTICS_ENABLED";
        internal const string MIKROS_ADDED = "MIKROS_ADDED";
